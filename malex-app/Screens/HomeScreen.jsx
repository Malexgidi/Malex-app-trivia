      ...
      <View style={styles.joe}>
        <View style={styles.groupLayout}>
          <Image
            style={[styles.groupItem, styles.groupLayout]}
            resizeMode="cover"
            source={require('../assets/images/Ellipse2524.png')}
          />
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require('../assets/images/2913.png')}
          />
        </View>
        <View style={styles.joeGroup}>
      ...
      <View style={styles.joe}>
        <View style={styles.groupLayout}>
          <Image
            style={[styles.groupItem, styles.groupLayout]}
            resizeMode="cover"
            source={require('../assets/images/Ellipse2525.png')}
          />
          <Image
            style={[styles.icon1, styles.iconLayout1]}
            resizeMode="cover"
            source={require('../assets/images/2914.png')}
          />
        </View>
        <View style={styles.joeGroup}>
  ...
  <View style={[styles.component1, styles.barsPosition]}>
    ...
    <View style={styles.streamlinestore1Parent}>
      <Image
        ...
        resizeMode="cover"
        source={require('../assets/images/streamlinestore1.png')}
      />
      <Text style={[styles.wallet, styles.text4Typo]}>Store</Text>
    </View>
    <View style={styles.fluenttrophy28RegularParent}>
      <Image
        style={styles.fluenttrophy28RegularIcon}
        resizeMode="cover"
        source={require('../assets/images/fluenttrophy28regular.png')}
      />
